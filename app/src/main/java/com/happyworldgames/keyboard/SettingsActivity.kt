...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.checkboxTapInput.isChecked = sharedPreferences.getBoolean("enable_tap_input", false)
        ...
        binding.checkboxTapInput.setOnCheckedChangeListener { _, isChecked ->
            sharedPreferences.edit { putBoolean("enable_tap_input", isChecked) }
        }
    ...
    private fun resetToDefaults() {
        ...
        sharedPreferences.edit {
            ...
            putBoolean("enable_tap_input", false)
        ...
        binding.checkboxTapInput.isChecked = false
